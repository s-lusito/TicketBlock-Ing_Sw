...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> handleGenericException(Exception exception) {
        ErrorResponse errorResponse= ErrorResponse.builder().message("Internal Server Error").build();
    ...
    public ResponseEntity<?> handleBadCredentialsException(BadCredentialsException exception) {
        ...
        ErrorResponse errorResponse= ErrorResponse.builder().message("Authentication failed: Invalid email or password").status(status.value()).build();
        return ResponseEntity.status(status).body(errorResponse);
    }
